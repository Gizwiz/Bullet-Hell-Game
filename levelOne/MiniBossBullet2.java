...
/*
 * Basic bullet. Receives velX/velY parameters.
 */

public class MiniBossBullet2 extends GameObject{
	
	private Image bullet;
	private Handler handler;

	public MiniBossBullet2(float x, float y, float velX, float velY, ID id, Handler handler) {
		super(x, y, velX, velY, id);
		this.handler = handler;
		this.velX = velX;
		this.velY = velY;
		try {
			bullet = ImageIO.read(new File("bin/used/tripleShotBullet3.png"));
		} catch (IOException e) {
	...
	public Rectangle getBounds(){
		return new Rectangle((int)x+20, (int)y+19, 14, 14);
	}
	...
	public void render(Graphics2D g2d) {
		g2d.drawImage(bullet, (int)x, (int)y, 55, 55, null);
		if(MainSettings.showHitBoxes){
		g2d.setColor(Color.red);
		g2d.drawRect((int)x+20,(int)y+19, 14, 14);
		}
	}
