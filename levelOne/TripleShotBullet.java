...
public class TripleShotBullet extends GameObject{
	
	private BufferedImage bullet;
	private Handler handler;

	public TripleShotBullet(float x, float y, float velX, float velY, ID id, Handler handler) {
		super(x, y, velX, velY, id);
		this.handler = handler;
		try {
			bullet = ImageIO.read(new File("bin/used/tripleShotBullet.png"));
		} catch (IOException e) {
