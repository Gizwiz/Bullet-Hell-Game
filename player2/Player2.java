...
public class Player2 extends GameObject{
	...
	public Player2(float x, float y, ID Id, float velX, float velY, Handler handler) {
		...
		try {
			...
			player=ImageIO.read(new File("bin/used/player2UP.png"));
			fadedPlayer = ImageIO.read(new File("bin/used/player2UPFADED.png"));
			}
...
//////////////////////////////////////////////////////
		...
		if (KeyInput.keyEight == true && playerBombs >= 1 && bombTimer <=0){
			...
			playerBombs-=1;
			handler.addObject(new BombOne (Player2.playerX+12, Player2.playerY+12,ID.Bomb,0, 0,handler));
		}
		...
		if (playerHealth <= 0){
			...
			highScore = new NewHighScorePlayer2();
